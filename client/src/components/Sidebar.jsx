...
import { LuCircleQuestionMark, LuCoins, LuHome, LuMessageCircle, LuInfo, LuCircleUser, LuLogOut,  LuCircleAlert } from '../components/Icons';
  ...
  if (ok) {
    ...
    props.dispatch({
      ...
      value: {
        on: true,
        msg: data.error,
        icon: < LuCircleAlert size={32} color='red' />
      }
    })
  }
}
